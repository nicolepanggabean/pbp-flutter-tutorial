...
class _MyFormPageState extends State<MyFormPage> {
  ...
  displayDegree() {
    if (undergraduateDegree) {
      return Text('Degree: Undergraduate');
    } else if (diplomaDegree) {
      return Text('Degree: Diploma');
    } else if (masterDegree) {
      return Text('Degree: Master');
    } else {
      return Text('Degree: Doctor');
    }
  }

  displayAge() {
    return Text('Age: ${age.round()}');
  }

  displayClass() {
    return Text('Class: ' + pdbClass);
  }

  displayPractice() {
    if (_switchValue) {
      return Text('Practice Mode: True');
    } else {
      return Text('Practice Mode: False');
    }
  }
